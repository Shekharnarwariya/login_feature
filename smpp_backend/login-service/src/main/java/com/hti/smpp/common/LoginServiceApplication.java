...
/**
 * Main entry point for the Login Service Spring Boot application.
 * It includes lifecycle methods for initialization and destruction,
...
public class LoginServiceApplication {
    ...
    /**
     * Initializes resources or services needed by the application.
     * This method is called after the bean is created and dependency injection is complete.
     */
    @PostConstruct
     ...
     * This method is called when the bean is about to be destroyed.
     */
    @PreDestroy
