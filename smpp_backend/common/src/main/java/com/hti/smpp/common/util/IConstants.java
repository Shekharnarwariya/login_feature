...
public final class IConstants {
	...
	// -------- path ------------------------------
	public static final String HOME_DIR = ContextListener.property.getProperty("home.dir");
	...
	public static final String TOMCAT_DIR = HOME_DIR + ContextListener.property.getProperty("tomcat.dir");
	public static final String BIN_DIR = TOMCAT_DIR + ContextListener.property.getProperty("tomcat.bin.dir");
	...
	public static final String WEBSMPP_EXT_DIR = HOME_DIR + "websmpp//";
	// ------------ Prefix Settings ---------------
	...
	public static final String SUCCESS_KEY = ContextListener.property.getProperty("load.success");
	public static final String SHEDULE_MORE_KEY = ContextListener.property.getProperty("load.shedule_more");
	public static final String FAILURE_KEY = ContextListener.property.getProperty("load.failure");
	public static final String INVALID_SESSION = ContextListener.property.getProperty("load.invalidSession");
	public static final String USER_SESSION_KEY = ContextListener.property.getProperty("load.userSessionKey");
	...
	public static final int SERVER_ID = Integer.parseInt(ContextListener.property.getProperty("load.serverid"));
	public static String GATEWAY_NAME = ContextListener.property.getProperty("load.gateway");
	public static String ip = ContextListener.property.getProperty("load.ip");
