...
public class ReportController {
	...
	public List<BulkEntry> abortBatchReport(@Valid@Parameter(description = "Username") @RequestHeader String username,
		...
		return abortBatchReportService.abortBatchReport(username, customReportForm, lang);
	}

	@PostMapping("/balance-report-view")
	@Operation(summary = "Balance Report View", description = "View balance report")
	public ResponseEntity<?> balanceReportView(@Valid
			@Parameter(description = "Username") @RequestHeader String username,
...
/////////////////////Blocked
	...
	public ResponseEntity<?> blockedReportView(@Valid
			@Parameter(description = "Username") @RequestHeader String username,
	...
	public ResponseEntity<?> campaignReportview(@Valid@Parameter(description = "Username") @RequestHeader String username,
			@Parameter(description = "Custom Report Form") @RequestBody CampaignReportRequest customReportForm,
			@Parameter(description = "language of the report") @RequestParam String lang,
			HttpServletResponse response) {
		return campaignReportService.CampaignReportview(username, customReportForm, lang);
	}
	...
	public ResponseEntity<?> campaignReportdoc(@Valid@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form")@RequestBody CampaignReportRequest customReportForm,
			@Parameter(description = "language of the report") @RequestParam String lang,
			HttpServletResponse response) {
		return campaignReportService.CampaignReportDoc(username, customReportForm, response, lang);
	}

	@PostMapping("/campaign-report-xls")
	@Operation(summary = "Campaign Report XLS", description = "Generate Campaign report in XLS format")
	public ResponseEntity<?> campaignReportxls(@Valid@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form") @RequestBody CampaignReportRequest customReportForm,
			@Parameter(description = "language of the report") @RequestParam String lang,
			HttpServletResponse response) {
		return campaignReportService.CampaignReportxls(username, customReportForm, response, lang);
	}

	@PostMapping("/campaign-report-pdf")
	@Operation(summary = "Campaign Report PDF", description = "Generate Campaign report in PDF format")
	public ResponseEntity<?> campaignReportPdf(@Valid@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form") @RequestBody CampaignReportRequest customReportForm,
			@Parameter(description = "language of the report") @RequestParam String lang,
			HttpServletResponse response) {
		return campaignReportService.CampaignReportPdf(username, customReportForm, response, lang);
	}
///////////////
	...
	public ResponseEntity<?> contentReportView(@Valid@Parameter(description = "Username") @RequestHeader String username,
			@Parameter(description = "Custom Report Form") @RequestBody ContentReportRequest customReportForm,
			@Parameter(description = "language of the report") @RequestParam String lang) {
		return contentReportService.ContentReportView(username, customReportForm, lang);
	}

	@PostMapping("/content-report-xls")
	@Operation(summary = "content Report PDF", description = "Generate content report in PDF format")
	public ResponseEntity<?> contentReportxls(@Valid@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form") @RequestBody ContentReportRequest customReportForm,
			@Parameter(description = "language of the report") @RequestParam String lang,
			HttpServletResponse response) {
		return contentReportService.ContentReportxls(username, customReportForm, response, lang);
	}
	...
	public ResponseEntity<?> contentReportPdf(@Valid@Parameter(description = "Username") @RequestParam String username,
			...
			@Parameter(description = "language of the report") @RequestParam String lang,
			HttpServletResponse response) {
		return contentReportService.ContentReportPdf(username, customReportForm, response, lang);
	}
	...
	public ResponseEntity<?> contentReportDoc(@Valid@Parameter(description = "Username") @RequestParam String username,
			...
			@Parameter(description = "language of the report") @RequestParam String lang,
			HttpServletResponse response) {
		return contentReportService.ContentReportDoc(username, customReportForm, response, lang);
	}
	...
	public ResponseEntity<?> userDeliveryReportView(@Valid@RequestHeader String username,
			...
			@Parameter(description = "language of the report") @RequestParam String lang) {
		return deliveryService.UserDeliveryReportView(username, customReportForm, lang);
	...
	public ResponseEntity<?> userDeliveryReportXls(@Valid@RequestParam String username,
			...
			@Parameter(description = "language of the report") @RequestParam String lang) {
		return deliveryService.UserDeliveryReportxls(username, customReportForm, response, lang);
	}
	...
	public ResponseEntity<?> userDeliveryReportPdf(@Valid@RequestParam String username,
			@RequestBody UserDeliveryForm customReportForm, HttpServletResponse response,
			@Parameter(description = "language of the report") @RequestParam String lang) {
		return deliveryService.UserDeliveryReportPdf(username, customReportForm, response, lang);
	...
	public ResponseEntity<?> userDeliveryReportDoc(@Valid@RequestParam String username,
			@RequestBody UserDeliveryForm customReportForm, HttpServletResponse response,
			@Parameter(description = "language of the report") @RequestParam String lang) {
		return deliveryService.UserDeliveryReportDoc(username, customReportForm, response, lang);
	...
	public ResponseEntity<?> downloadLookupReportXLS(@Valid@RequestParam String username,
			@RequestBody LookUpReportRequest customReportForm, @RequestParam String lang, HttpServletResponse response) {
		return  lookupReportService.LookupReportxls(username, customReportForm, lang, response);
	...
	public ResponseEntity<?> downloadLookupReportPDF(@Valid@RequestParam String username,
			@RequestBody LookUpReportRequest customReportForm, @RequestParam String lang, HttpServletResponse response) {
		return lookupReportService.LookupReportPdf(username, customReportForm, lang, response);
	...
	public ResponseEntity<?> downloadLookupReportDoc(@Valid@RequestParam String username,
			@RequestBody LookUpReportRequest customReportForm, @RequestParam String lang, HttpServletResponse response) {
		return lookupReportService.LookupReportDoc(username, customReportForm, lang, response);
	...
	public ResponseEntity<?> recheckLookupReport(@Valid@RequestParam String username,
			@RequestBody LookUpReportRequest customReportForm, @RequestParam String lang, HttpServletResponse response) {
		return lookupReportService.LookupReportRecheck(username, customReportForm, lang, response);
	...
	public ResponseEntity<?> getCustomizedReportView(@Valid@RequestHeader String username,
		...
		return customizedReportService.CustomizedReportView(username, customReportForm, lang);
	}
	...
	public ResponseEntity<?> downloadCustomizedReportDoc(@Valid@RequestParam String username,
			@RequestBody CustomizedReportRequest customReportForm, @RequestParam String lang,
			HttpServletResponse response) {
		return customizedReportService.CustomizedReportdoc(username, customReportForm, response, lang);
	...
	public ResponseEntity<?> downloadCustomizedReportPDF(@Valid@RequestParam String username,
			@RequestBody CustomizedReportRequest customReportForm, @RequestParam String lang,
			HttpServletResponse response) {
		return customizedReportService.CustomizedReportpdf(username, customReportForm, response, lang);

	}
////////////////performance
	@PostMapping("/performance-report-view")
	@Operation(summary = "Performance Report View", description = "View performance report")
	public ResponseEntity<?> performanceReportView(@Valid@Parameter(description = "Username") @RequestHeader String username,
	...
	public ResponseEntity<?> downloadPerformanceReportXLS(@Valid@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form") @RequestBody PerformanceReportRequest customReportForm,
			@Parameter(description = "Language of the report") @RequestParam String lang,
			HttpServletResponse response) {
	...
	public ResponseEntity<?> downloadPerformanceReportPDF(@Valid@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form") @RequestBody PerformanceReportRequest customReportForm,
			@Parameter(description = "Language of the report") @RequestParam String lang,
			HttpServletResponse response) {
	...
	public ResponseEntity<?> downloadPerformanceReportDOC(@Valid@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form") @RequestBody PerformanceReportRequest customReportForm,
			@Parameter(description = "Language of the report") @RequestParam String lang,
			HttpServletResponse response) {
	...
	public ResponseEntity<?> dlrSummaryReportView(@Valid@Parameter(description = "Username") @RequestHeader String username,
	...
	public ResponseEntity<?> downloadDlrSummaryReportDOC(@Valid@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form") @RequestBody DlrSummaryReport customReportForm,
			@Parameter(description = "Language of the report") @RequestParam String lang,
			HttpServletResponse response) {
	...
	public ResponseEntity<?> downloadDlrSummaryReportPDF(@Valid@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form") @RequestBody DlrSummaryReport customReportForm,
			@Parameter(description = "Language of the report") @RequestParam String lang,
			HttpServletResponse response) {
	...
	public ResponseEntity<?> downloadDlrSummaryReportXLS(@Valid@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form") @RequestBody DlrSummaryReport customReportForm,
			@Parameter(description = "Language of the report") @RequestParam String lang,
			HttpServletResponse response) {
...
///////////////////////latency/////////////
	...
	public ResponseEntity<?> latencyReportView(@Valid@Parameter(description = "Username") @RequestHeader String username,
	...
	public ResponseEntity<?> downloadLatencyReportXLS(@Valid@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form")  @RequestBody LetencyReportRequest customReportForm,
			@Parameter(description = "Language of the report") @RequestParam String lang,
			HttpServletResponse response) {
	...
	public ResponseEntity<?> downloadLatencyReportPDF(@Valid@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form") @RequestBody LetencyReportRequest customReportForm,
			@Parameter(description = "Language of the report") @RequestParam String lang,
			HttpServletResponse response) {
	...
	public ResponseEntity<?> downloadLatencyReportDOC(@Valid@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form")  @RequestBody LetencyReportRequest customReportForm,
			@Parameter(description = "Language of the report") @RequestParam String lang,
			HttpServletResponse response) {
...
////////////////
	...
	public ResponseEntity<?> profitReportView(@Valid@Parameter(description = "Username") @RequestHeader String username,
	...
	public ResponseEntity<?> generateProfitReportXls(@Valid@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form") @RequestBody ProfitReportRequest customReportForm,
			@Parameter(description = "Language of the report") @RequestParam String lang,
			HttpServletResponse response) {
	...
	public ResponseEntity<?> generateProfitReportPdf(@Valid@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form") @RequestBody ProfitReportRequest customReportForm,
			@Parameter(description = "Language of the report") @RequestParam String lang,
			HttpServletResponse response) {
	...
	public ResponseEntity<?> generateProfitReportDoc(@Valid@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form") @RequestBody ProfitReportRequest customReportForm,
			@Parameter(description = "Language of the report") @RequestParam String lang,
			HttpServletResponse response) {
	...
	public ResponseEntity<?> generateScheduleReport(@Valid
			@Parameter(description = "Username") @RequestHeader String username,
			@Parameter(description = "Custom Report Form") @RequestBody ScheduleReportRequest customReportForm,
			@Parameter(description = "Language of the report") @RequestParam String lang) {
		return scheduleReportService.ScheduleReport(username, customReportForm, lang);
	}
	...
	public ResponseEntity<?> generateSmscDlrReportView(@Valid
			@Parameter(description = "Username") @RequestHeader String username,
	...
	public ResponseEntity<?> generateSmscDlrReportXls(@Valid
			@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form") @RequestBody SmscDlrReportRequest customReportForm,
			@Parameter(description = "Language of the report") @RequestParam String lang,
			HttpServletResponse response) {
		return smscDlrReportService.SmscDlrReportxls(username, customReportForm, lang, response);
	}
	...
	public ResponseEntity<?> generateSmscDlrReportPdf(@Valid
			@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form") @RequestBody SmscDlrReportRequest customReportForm,
			@Parameter(description = "Language of the report") @RequestParam String lang,
			HttpServletResponse response) {
		return smscDlrReportService.SmscDlrReportpdf(username, customReportForm, lang, response);
	}
	...
	public ResponseEntity<?> generateSmscDlrReportDoc(@Valid
			@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form") @RequestBody SmscDlrReportRequest customReportForm,
			@Parameter(description = "Language of the report") @RequestParam String lang,
			HttpServletResponse response) {
	...
	public ResponseEntity<?> executeCustomReport(@Valid@Parameter(description = "Username") @RequestHeader String username,
		...
		return submissionReportService.execute(username, customReportForm, response,lang);
	...
	public ResponseEntity<?> generateSummaryReportView(@Valid
			@Parameter(description = "Username") @RequestHeader String username,
			@RequestBody SummaryReportForm customReportForm,
			@Parameter(description = "Language of the report") @RequestParam String lang) {
		System.out.println("run 570 in controller");
		return summaryReportService.SummaryReportview(username, customReportForm, lang);
	}
	...
	public ResponseEntity<?> generateSummaryReportXls(@Valid
			@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form") @RequestBody SummaryReportForm customReportForm,
			HttpServletResponse response,
			@Parameter(description = "Language of the report") @RequestParam String lang) {
		System.out.println("run 570 in controller");
		return summaryReportService.SummaryReportxls(username, customReportForm, response, lang);
	...
	public ResponseEntity<?> generateSummaryReportPdf(@Valid
			@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form") @RequestBody SummaryReportForm customReportForm,
			HttpServletResponse response,
			@Parameter(description = "Language of the report") @RequestParam String lang) {
		return summaryReportService.SummaryReportpdf(username, customReportForm, response, lang);
	...
	public ResponseEntity<?> generateSummaryReportDoc(@Valid
			@Parameter(description = "Username") @RequestParam String username,
			@Parameter(description = "Custom Report Form") @RequestBody SummaryReportForm customReportForm,
			HttpServletResponse response,
			@Parameter(description = "Language of the report") @RequestParam String lang) {
		return summaryReportService.SummaryReportdoc(username, customReportForm, response, lang);
