...
public class MailUtility {
	...
	public static void send(String email, String fileName, String subject, String from, boolean IsCC)
		 ...
		 * 
		 * @Override protected PasswordAuthentication getPasswordAuthentication() { return new PasswordAuthentication(mailAuthUser, pass); } });
		 * 
		...
		/*
		 * BodyPart messageBodyPart = new MimeBodyPart(); messageBodyPart.setText(messagetext); multipart.addBodyPart(messageBodyPart);
		 */
