...
public class SevenBitChar {
	...
	/*
	 * public static String getHexValue(String msg) { String HexMessage = ""; char[]
	 * arr = msg.toCharArray(); String ascii = ""; for (int i = 0; i < arr.length;
	 * i++) {
	 * 
	 * // System.out.println("char : "+i); if (arr[i] != ',') { ascii += "" +
	 * arr[i]; } else if (arr[i] == ',' || arr[i] == ' ') {
	 * //System.out.println("ascii : "+ascii); String hexv = (String)
	 * hashTabOne.get((ascii.trim())); System.out.println("hex : "+hexv); if (hexv
	 * != null) { HexMessage += hexv; } else { HexMessage += ""; }
	 * 
	 * ascii = ""; }
	 * 
	 * }
