...
/**
 * This class contains all constant data values used in the SMPP protocol ver 3.4 and in the library as well as some global variable defaults.
 *
 * @author Logica Mobile Networks SMPP Open Source Team
 * @version 1.3, 16 Nov 2001
 */
/*
 * 13-07-01 ticp@logica.com default queue timeout QUEUE_TIMEOUT increased from 50 msec to 10 sec 21-09-01 ticp@logica.com added constants for registered delivery 28-09-01 ticp@logica.com DEFAULT_IO_BUF_SIZE moved to the TCPIPConnection class and renamed to DFLT_IO_BUF_SIZE 10-10-01 ticp@logica.com
 * max address lengths fixed according smpp spec 16-11-01 ticp@logica.com added multibyte encoding support
 */
public class Data {
	public static final int SM_CONNID_LEN = 16;
	public static final int SM_MSG_LEN = 254;
	public static final int SM_SYSID_LEN = 20;
	public static final int SM_MSGID_LEN = 64;
	public static final int SM_PASS_LEN = 20;
	public static final int SM_DATE_LEN = 17;
	public static final int SM_SRVTYPE_LEN = 6;
	public static final int SM_SYSTYPE_LEN = 20;
	...
	public static final int ESME_RCOVERR = 0x00000012;
	...
	public static final int ESME_RINVBALANCE = 0x0000040B; // Added By Raj for Insufficient credits
	...
	public static final int SM_UDH_GSM_2 = 0x43; // User Data Header indicator set by amit_vish
	...
	/**
	 * @deprecated As of version 1.3 of the library there are defined new encoding constants for base set of encoding supported by Java Runtime. The <code>CHAR_ENC</code> is replaced by <code>ENC_ASCII</code> and redefined in this respect.
	 */
	public static final String CHAR_ENC = ENC_ASCII;
	public static final String DFLT_MSGID = "";
	public static final String DFLT_MSG = "arshad";
	...
	public static final long UNBIND_TIMEOUT = 10000;
	public static final long RECEIVER_TIMEOUT = 30000;
	public static final long CONNECTION_RECEIVE_TIMEOUT = 10000;
	public static final long COMMS_TIMEOUT = 20000;
