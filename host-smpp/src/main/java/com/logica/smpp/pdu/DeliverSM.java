 ...
 * correctly return values > 127 20-11-01 ticp@logica.com added support for multibyte string encoding for short message
 */
public class DeliverSM extends Request {
	...
	private TLVOctets networkErrorCode = new TLVOctets(Data.OPT_PAR_NW_ERR_CODE, Data.OPT_PAR_NW_ERR_CODE_MIN,
			Data.OPT_PAR_NW_ERR_CODE_MAX); // exactly 3
	private TLVByte messageState = new TLVByte(Data.OPT_PAR_MSG_STATE);
	private TLVString receiptedMessageId = new TLVString(Data.OPT_PAR_RECP_MSG_ID, Data.OPT_PAR_RECP_MSG_ID_MIN,
			Data.OPT_PAR_RECP_MSG_ID_MAX); // 1-
	// private String msg_id; // Added by GOPI
	private String clientName;// Added by Gopi
	private String flag;// Added by Amit_vish
	private String smsc;// Added by Amit_vish
