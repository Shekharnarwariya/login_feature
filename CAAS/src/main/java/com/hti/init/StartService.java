...
import com.hti.smpp.common.flag.FlagUpdateThread;
...
public class StartService implements Runnable {
	...
	private FlagUpdateThread flagUpdateThread;
	long delay = 1000;
	...
	private void startApplication() throws FileNotFoundException, IOException {
		...
		flagUpdateThread = new FlagUpdateThread(delay);
		new Thread(flagUpdateThread,"flagUpdateThread").start();
	}
